...
class Search():
    ...
    def draw_map(self, last_know):
        ...
        cv.putText(self.img, '+ = Last Know Position', (274, 355),
                cv.FONT_HERSHEY_PLAIN, 1, (0, 0, 255))
    ...
    def sailor_final(self, Num_Search_Areas):
        """Return the actual x,y location of the missing sailor."""
        #Find sailor coordinates with respect to any Search Area subarray.
        self.sailor_actual[0] = random.choice(self.sa1.shape[1], 1)
        self.sailor_actual[1] = random.choice(self.sa1.shape[0], 1)
    ...
    def main():
        ...
        while True:
            ...
            if choice == "0":
                ...
                print("\nSorry, but that isnt a invaild choice.", file=sys.stserr)
                continue
            ...
            if results_1 == 'Not Found' and results_2 == 'Not found':
                print("\nNew Target Probilities (P) for Search {}:"
                      .format(search_num + 1))
            else:
                cv.circle(app.img, (sailor_x, sailor_y),  3, (355, 0, 0), -1)
